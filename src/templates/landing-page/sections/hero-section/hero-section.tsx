    ...
    <section className="mt-16 container relative flex items-center justify-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[20rem] md:h=[36rem] items-center">
        <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
          ...
          <div className="flex flex-col items-start justify-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-300 text-body-md">Crie o seu site em menos de 5 minutos</span>
            </div>
            <div className="flex items-center gap-2">
              <Store className="text-cyan-100 h-4 w-4" />
              <span className="text-gray-300 text-body-md">Acompanhe e otimize seu negócio online</span>
            </div>
          </div>

          <div className="text-white flex flex-col gap-2 mt-5 items-center md:items-start lg:items-start">
            <Button className="rounded-full w-fit">Criar loja grátis <ArrowRight /></Button>
        ...
        <div className="relative h-[20rem] hidden md:h-full order-first md:order-last items-center justify-center md:flex lg:flex">
          <Image className="h-full w-auto object-contain" width={200} height={400} src='/hero-section.svg' alt="Ilustração com ícones de compras" />
        </div>
      </div>
    </section>
  )
